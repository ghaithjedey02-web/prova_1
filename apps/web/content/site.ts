...
export const simulator = {
  n: '07',
  label: 'Prova DOLMIR',
  headline: 'Scegliete un settore. Fate girare il processo.',
  body:
    'Questa è una simulazione che gira interamente nel vostro browser: nessuna chiamata esterna, nessun dato reale. Scegliete lo scenario più vicino al vostro lavoro, avviate il processo e decidete voi, al cancello. Il motore vero è nel capitolo 05; qui vedete la stessa architettura su sei settori.',
  stages: [
    'INPUT RICEVUTO',
    'LETTURA',
    'COMPRENSIONE',
  ...
  scenarios: [
    {
      ...
      fields: [
        ...
        { k: 'Offerta di origine', v: '2026/184', conf: 0.98 },
        { k: 'Righe ordine', v: '3 · SL-4410, PF-2205, BC-118', conf: 0.97 },
        { k: 'Consegna', v: '20-11-2026', conf: 0.95 },
      ],
      confidence: 96.8,
      gateTone: 'ready',
    ...
    },
    {
      ...
      fields: [
        { k: 'Ritiro', v: 'Bergamo · mag. 2 · 8–12', conf: 0.96 },
        { k: 'Consegna', v: 'Bologna Interporto 5.4', conf: 0.95 },
        { k: 'Colli / peso', v: '6 EPAL · 2.840 kg', conf: 0.97 },
        { k: 'Data', v: '04-09-2026', conf: 0.93 },
      ],
      confidence: 94.1,
      gateTone: 'ready',
    ...
    },
    {
      ...
      fields: [
        { k: 'Righe ordine', v: '12 · tutte a listino', conf: 0.97 },
        { k: 'Sconto', v: '8% contrattuale', conf: 0.98 },
        { k: 'Disponibilità', v: '10 righe pronte', conf: 0.99 },
        { k: 'Sotto scorta', v: '2 righe · riordino 6 gg', conf: 0.91 },
      ],
      confidence: 88.3,
      gateTone: 'attention',
    ...
    },
    {
      ...
      fields: [
        { k: 'Esigenza', v: 'gestione richieste email', conf: 0.9 },
        { k: 'Orizzonte', v: 'entro l’autunno', conf: 0.82 },
        { k: 'Azienda', v: '— non indicata', conf: 0.31 },
        { k: 'Budget', v: '— non indicato', conf: 0.22 },
      ],
      confidence: 71.2,
      gateTone: 'complete',
    ...
    },
    {
      ...
      fields: [
        { k: 'Numero', v: '771/2026', conf: 0.99 },
        { k: 'Totale', v: '€ 5.270,40', conf: 0.98 },
        { k: 'Scadenza', v: '30 gg d.f.', conf: 0.96 },
        { k: 'Vs ordine', v: '2026/091 · +2,4%', conf: 0.94 },
      ],
      confidence: 90.6,
      gateTone: 'attention',
    ...
    },
    {
      ...
      fields: [
        { k: 'Impianto', v: 'etichettatura · linea 2', conf: 0.97 },
        { k: 'Sintomo', v: 'blocco intermittente', conf: 0.95 },
        { k: 'Urgenza', v: 'alta · capacità ridotta', conf: 0.93 },
