  ...
  scenarios: [
    ...
    },
    {
      ...
      fields: [
        ...
        { k: 'Azienda', v: 'NON DETERMINATO', conf: 0.31, state: 'missing' },
        { k: 'Budget', v: 'NON DETERMINATO', conf: 0.22, state: 'missing' },
      ],
      confidence: 71.2,
      gateTone: 'complete',
    ...
    },
    {
      ...
      fields: [
        ...
        { k: 'Vs ordine', v: '2026/091 · +2,4%', conf: 0.94, state: 'warn' },
      ],
      confidence: 90.6,
      gateTone: 'attention',
    ...
    },
    {
      ...
      fields: [
        { k: 'Cliente', v: '«Meccanica Rossi» ≈ Officine Rossi S.r.l.', conf: 0.55, state: 'warn' },
        { k: 'Codice', v: 'SL-441 · AMBIGUO (SL-4410 / SL-4415)', conf: 0.5, state: 'conflict' },
        { k: 'Quantità PF-2205', v: '40 ↔ 60 · CONTRADDIZIONE', conf: 0.44, state: 'conflict' },
        { k: 'Consegna', v: '12/09 · NON COMPATIBILE', conf: 0.38, state: 'conflict' },
      ],
      confidence: 58.4,
      gateTone: 'blocked',
