          ...
          {c.chain.map((step, i) => (
            <Reveal key={step.k} as="li" delay={i * 90} className="bg-surface/92 backdrop-blur-md">
              <div className="relative flex h-full flex-col p-8">
                ...
                <p className="mt-5 text-[length:var(--text-small)] leading-relaxed text-muted">{step.d}</p>
        ...
        <Reveal delay={140}>
          <figure className="mt-[var(--space-block)] border border-amber-line bg-amber-soft/50 backdrop-blur-md">
            ...
            <div className="px-6 py-9 sm:px-10 sm:py-11">
              ...
              <p className="mt-6 max-w-[58ch] text-[length:var(--text-small)] leading-relaxed text-ink-2">{c.quoteNote}</p>
            </div>
          </figure>
        </Reveal>
      </Container>
